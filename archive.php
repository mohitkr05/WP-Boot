			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title">
						<?php
							if ( is_category() ) {
								printf( __( 'Category Archives: %s', 'wpboot' ), '<span>' . single_cat_title( '', false ) . '</span>' );
								...
								*/
								...
								printf( __( 'Monthly Archives: %s', 'wpboot' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );

							} elseif ( is_year() ) {
								printf( __( 'Yearly Archives: %s', 'wpboot' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
